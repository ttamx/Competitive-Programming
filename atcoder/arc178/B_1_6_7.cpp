...
void runcase(){
    ...
    a--,b--,c--;
    if(a>b)swap(a,b);
    mint n=binpow(mint(10),a)*9;
    mint tot=n*(n+1)+((binpow(mint(10),a)+binpow(mint(10),b))*9-1-2*n)*n;
    if(c==b){
        mint m=binpow(mint(10),a+1)-1;
        mint m1=m-n;
        if(a==b){
            tot-=n*(n+1)/2+(2*n-m1-1)*m1/2;
        }else{
            tot-=n*(n+1)/2+m1*n;
        }
        cout << tot << "\n";
        ...
        if(a==b){
            ...
            mint m=binpow(mint(10),b)*9-binpow(mint(10),a);
            mint m1=m-n;
            tot-=n*(n+1)/2+m1*n;
        }
        cout << tot << "\n";
